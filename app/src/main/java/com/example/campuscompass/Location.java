...
public class Location {
    ...
    public Location(String name, ArrayList<String> places,ArrayList<Integer> placePositions, int image, int level, boolean isStairs, float stairsAngle, Location stairs, Location left, Location right, Location front, Location back, Location bottomLeft,Location bottomRight, Location topLeft, Location topRight) {
        this.name = name;
        this.places = places;
        this.image = image;
        this.level = level;
